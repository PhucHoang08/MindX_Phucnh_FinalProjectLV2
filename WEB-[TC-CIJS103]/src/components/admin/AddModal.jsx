...
const AddProductModal = ({ setShowAddModal, setIsLoading, isLoading, loadProducts }) => {
        ...
        <Formik
          ...
          onSubmit={async (values, { setSubmitting, resetForm }) => {
            ...
            try {
              ...
              const uniqueProducts = Array.from(new Map(currentProducts.map((p) => [p.id, p])).values());

              if (uniqueProducts.some((p) => p.id === values.id.trim())) {
              ...
              const updatedProducts = [...uniqueProducts, newProduct];
            ...
            <Form className="space-y-4">
              ...
              <div className="flex justify-end space-x-2">
                <button
                  ...
                  className="px-4 py-2 font-futura border rounded text-gray-600 hover:bg-gray-100 transition-all duration-300"
                  disabled={isLoading}
                >
                  CANCEL
                </button>
                <button
                  type="submit"
                  className="relative bg-blue-600 font-futura text-white px-4 py-2 rounded hover:bg-blue-700 disabled:bg-blue-400 transition-all duration-300"
                  disabled={isLoading}
                >
                  {isLoading ? (
