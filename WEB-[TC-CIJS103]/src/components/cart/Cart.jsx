...
const Cart = () => {
  ...
  const removeItem = (id, size) => {
    const updatedCart = cartItems.filter((item) => !(item.id === id && item.size === size)); // Lọc ra sản phẩm không có ID cần xóa
    setCartItems(updatedCart);
      ...
      <>
        ...
        <div className="min-h-screen  py-10 mt-[90px]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-center text-red-500 font-futura ">CART IS EMPTY</p>
            <button
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="mt-6 text-right">
                <p className="text-xl font-futura">AMOUNT: $ {getTotal()} USD</p>
                <button
